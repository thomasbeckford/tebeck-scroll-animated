    ...
    <section ref={targetRef}>
      <div className="relative h-[800vh]">
        <div className="sticky top-1/2 flex origin-center -translate-y-1/2 justify-center">
          ...
          >
            <img src="/main-screen.png" className="h-auto w-full" />
            <motion.img
          ...
          >
            <span className="text-primary">
              Stay up-to-date with latests trends
            </span>
            <br />
            Improve my skills and learn new things every day.
          </motion.p>
        </div>
        <motion.p
          style={stylesWithCssVar({
          ...
          className="translate-y-centered-offset top-1/2 left-[20px] w-[500px] pl-16 text-2xl leading-tight text-white"
        >
          Self-taught with over 5 years of experience
          <br />
          <span className="text-primary">in the industry.</span>
        </motion.p>
        <motion.p
          style={stylesWithCssVar({
          ...
          className="translate-y-centered-offset top-1/2 right-[20px] w-[500px] pr-16 text-2xl leading-tight text-white"
        >
          Passionate about meeting new people, playing musical instruments, and
          <br />
          <span className="text-primary">continously learning new things.</span>
        </motion.p>
      </div>
    </section>
  );
